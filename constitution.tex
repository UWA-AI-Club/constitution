...
\usepackage{tocloft}
\renewcommand{\cftsecfont}{\footnotesize} % Change section font size
\renewcommand{\cftsubsecfont}{\footnotesize} % Change subsection font size
\renewcommand{\cftsubsubsecfont}{\footnotesize} % Change subsubsection font size
...
\begin{enumerate}[label=4.\arabic*]
    ...
    \begin{enumerate}[label=\theenumi.\arabic*]
        ...
        \item The Treasurer.
    \end{enumerate}
    \item The Immediate Past President may serve on the Executive Committee provided that they remain an enrolled student of the University.
    \item The position of Immediate Past President shall become vacant automatically if the individual ceases to be enrolled as a student of the University.
    \item The Immediate Past President shall hold the same rights and responsibilities as other Executive Committee members.
...
\item Notice of a General Meeting or Annual General Meeting shall be provided to all Financial Members at least two (2) days prior to the meeting.
\item Subject to 6.6 a General Meeting shall only consider business of which notice has been given on the agenda, or which arises out of minutes or reports.
...
\item Quorum of a General Meeting shall consist of eight (8) Financial Members.
\end{enumerate}

\section{7. Elections}
\begin{enumerate}[label=7.\arabic*]
\item No less than once per Guild Year the Club must hold an Election in which Financial Members may stand for election to the Committee (``Election'').

\item All Club Elections shall be conducted in accordance with the Student Guild Election Regulations and Student Guild Standing Orders.

\item A Returning Officer shall be appointed by the Executive Committee to oversee each Election.
  \begin{enumerate}[label=7.3.\arabic*]
    \item The Returning Officer must not be a candidate in the Election.
    \item The Returning Officer must not have ever served as a member of the Committee.
    \item Where a Returning Officer contravenes any provision of any applicable rule or regulation, they may be dismissed by special resolution approved by a two-thirds majority of all active Committee members.
  \end{enumerate}

\item The Returning Officer shall determine the procedural details of the election process, including nomination procedures, speech format, voting method (including electronic voting), and vote counting procedures, provided that the process is fair and consistent with this Constitution.

\item Elections shall be conducted by secret ballot.

\item For positions with a single vacancy, the candidate receiving the highest number of valid votes shall be elected.

\item For positions with multiple vacancies, members may vote for up to the number of available positions. The candidates receiving the highest number of valid votes shall be elected.

\item If a position remains unfilled following the Election, the Committee may appoint an eligible Financial Member to the vacant position by majority vote.

\item To be eligible to stand for Election a person must:
  \begin{enumerate}[label=7.9.\arabic*]
    \item Be a Financial Member of the Club;
    \item Be an enrolled UWA student, with full rights and privileges, for the twelve-month period during which they would hold office; and
    \item Agree to be bound by and comply with all applicable Codes of Conduct.
  \end{enumerate}

\item Nominations shall close no later than one (1) hour before voting is scheduled to commence. A nomination received after the close of nominations may be accepted at the discretion of the Returning Officer.

\item The Immediate Past President position is not won in an Election. The outgoing President is automatically appointed as the Immediate Past President, subject to the eligibility requirements set out in this Constitution.
...
\begin{enumerate}[label=10.\arabic*]
 \item If a Committee member resigns, becomes ineligible, or is otherwise unable to continue in their role, the Executive Committee may appoint an eligible Financial Member to fill the vacancy until the next Annual General Meeting.
 \item This provision applies to vacancies in both Executive Committee and Ordinary Committee positions.
\end{enumerate}
%
\section{11. Ordinary Committee}
\begin{enumerate}[label=11.\arabic*]
 \item The Ordinary Committee shall comprise:
    \begin{enumerate}[label=\theenumi.\arabic*]
        \item Head of Marketing (1);
        \item Head of Partnerships \& External Relations (1);
        \item Head of Community \& Events (1);
        \item Technical Leads (2);
        \item Marketing Officers (2);
        \item First Year Representative (1); and
        \item Ordinary Committee Members (3).
    \end{enumerate}
...
\item Any member, Financial, Ordinary, Executive, or Associate, only have their membership suspended or removed in accordance with articles 13.1 to 13.3 of this Constitution, or in the following circumstances:
    ...
    \end{enumerate}
\item A Committee member who fails to attend three (3) consecutive Committee meetings without reasonable excuse may be removed from office by a majority vote of the Executive Committee.
    \begin{enumerate}[label=\theenumi.\arabic*]
        \item The Committee member must be notified in writing and given an opportunity to provide an explanation before removal.
    \end{enumerate}
\end{enumerate}
